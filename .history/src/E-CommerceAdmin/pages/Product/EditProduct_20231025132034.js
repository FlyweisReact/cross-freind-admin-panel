...
const EditProduct = () => {
  ...
  useEffect(() => {
    if (data) {
      ...
      setDiscountInPercentage(data?.discountPercentage);
      setDiscountPrice(data?.discountPrice);
      setIsDealOfTheDay(data?.isDealOfTheDay);
      setMinDiscount(data?.minDiscount);
      setPer(data?.per);
      setRatings(data?.ratings);
      setMultipleArr(data?.sizePrice);
        ...
        <Form onSubmit={createProduct}>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Select onChange={(e) => setType(e.target.value)}>
              <option value={cake}>
                {" "}
                {cake ? cake : " Select Your Prefrence"}{" "}
              </option>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Select onChange={(e) => setIsDealOfTheDay(e.target.value)}>
              <option value={isDealOfTheDay} > {isDealOfTheDay ? isDealOfTheDay} Select Your Prefrence</option>
